    ...
    <form method="POST" action="{{ route('produk.store') }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_produk" value="{{ old('nama_produk') }}"
                   class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 @error('nama_produk') border-red-400 @enderror"
                   placeholder="Contoh: Isi Ulang Galon">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="harga" value="{{ old('harga') }}" min="0"
                   class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 @error('harga') border-red-400 @enderror"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="satuan" value="{{ old('satuan', 'galon') }}"
